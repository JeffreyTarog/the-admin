...
function Navbar() {
  ...
  function SubMenu(props:SubMenu) {
    return (
      <div className="flex">
        <div id="dropdownNavbar" className="absolute right-0 z-10 font-normal bg-white divide-y divide-slate-100 rounded-lg shadow w-44 dark:bg-slate-800 dark:divide-slate-600 transition ease-in-out delay-150 transform ">
          <div className="py-1">
  ...
  return (
    <>
      <nav className="w-full h-full bg-slate-50 dark:bg-slate-700 dark:border-slate-700 border-b shadow-sm">
        <div className="max-w-full h-full flex flex-wrap items-center justify-between ml-auto px-4">
          <span className="mx-1 text-lg font-normal text-gray-700 dark:text-slate-50">

          ...
          <div className="border-t dark:border-slate-700 flex p-3">
            ...
            <div className={`flex justify-between items-center
              ...
              <div className="leading-4">
                ...
                <span className="text-xs text-slate-600 dark:text-slate-200">johndoe@email.com</span>
              </div>
              <button>
        ...
        <div className='flex flex-col mb-1 relative rounded-md bg-slate-700/60'>
          <div
            ...
            onClick={() => {
              ...
              <span className={`text-sm overflow-hidden transition-all ${ expanded ? "w-52 ml-3" : "hidden"} ${activeLink ? "text-slate-100" : ""}`}>
                {text}
              </span>
              <span>
